...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Offroad_PowerSupplyLoadTestFailed", {CLEAR_ON_MANAGER_START, JSON}},
    ...
    {"PowerSupplyLoadTestLastResult", {PERSISTENT, JSON}},
    {"PowerSupplyLoadTestMaxTempC", {PERSISTENT, INT, "-1"}},
    {"PowerSupplyLoadTestMinDeviceVoltageMv", {PERSISTENT, INT, "7000"}},
    {"PowerSupplyLoadTestedCommit", {PERSISTENT, STRING}},
